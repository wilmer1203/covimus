...
const Projects = () => {
  ...
  return (
    <>
      <SEO
        title="Proyectos"
        description="Obras y proyectos en ejecución para la transformación del Municipio Sotillo. Consulta el avance de nuestra gestión."
              ...
              >
                <div className="inline-flex items-center gap-3 bg-slate-900/80 border border-white/10 backdrop-blur-md px-6 py-2 rounded-full mb-8 shadow-xl">
                  <div className="flex h-3 w-3 relative">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#C00000] opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-3 w-3 bg-[#C00000]"></span>
                  </div>
                  <span className="text-sm font-black text-white tracking-[0.2em] uppercase">Plan de Obras</span>
                </div>

                <h1 className="text-4xl md:text-7xl lg:text-8xl font-black text-white mb-8 tracking-tighter leading-none">
                  INFRAESTRUCTURA <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C00000] via-[#F0F0F0] to-[#C00000] drop-shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                    ESTRATÉGICA
                  </span>
                </h1>
              </motion.div>
