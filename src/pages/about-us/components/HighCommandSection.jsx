            ...
            <div className="relative z-20 w-full lg:w-8/12 p-6 md:p-8 flex flex-col justify-center">
                ...
                <motion.div variants={itemVariants} className="flex flex-col gap-4 mb-6 border-b border-white/5 pb-6">
                    <div>
                        ...
                        <h3 className="text-2xl md:text-3xl font-black text-white mb-1 leading-tight tracking-tight uppercase">
                            {leader.name}
                        </h3>
                        <p className="text-lg text-yellow-500 font-bold">{leader.position}</p>
                    </div>
                </motion.div>
        ...
        <section className="py-24 bg-slate-950 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black mb-6 text-transparent bg-clip-text bg-gradient-to-b from-[#C00000] via-[#ffcccc] to-[#C00000] drop-shadow-[0_0_25px_rgba(255,255,255,0.2)]">
                        Alto Mando
                    </h2>
                ...
                <div className="space-y-12">
                    ...
                    <div className="flex justify-center -my-6 relative z-0 opacity-50">
                        <div className="h-16 w-1 bg-gradient-to-b from-[#FFCC00]/50 to-slate-700" />
                    </div>
