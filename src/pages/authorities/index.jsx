...
const Authorities = () => {
   ...
   return (
      <div className="min-h-screen bg-background font-sans">
         <SEO
            title="Autoridades"
            description="Conoce a nuestras autoridades, lideradas por el Alcalde Dr. Jesús Marcano Tábata y el equipo directivo de COVIMUS."
            keywords="Autoridades, Alcalde Sotillo, Jesús Marcano Tábata, Directiva COVIMUS, Gobierno Corporativo"
            ogTitle="Autoridades - COVIMUS | Liderazgo y Estrategia"
            ogDescription="Conoce al equipo de liderazgo que impulsa la transformación de la infraestructura en Puerto La Cruz."
         />
